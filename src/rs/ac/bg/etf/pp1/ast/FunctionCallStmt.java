...
public class FunctionCallStmt extends DesignatorStatement {

    private Designator Designator;
    private ActualPars ActualPars;

    public FunctionCallStmt (Designator Designator, ActualPars ActualPars) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FunctionCallStmt(\n");
