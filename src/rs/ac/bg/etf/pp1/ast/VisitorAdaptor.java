...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(DifferentOp DifferentOp) { visit(); }
    ...
    public void visit(NestedExpr NestedExpr) { visit(); }
    ...
    public void visit(SingleNegExpr SingleNegExpr) { visit(); }
    ...
    public void visit(RelCondFact RelCondFact) { visit(); }
    ...
    public void visit(ForT ForT) { visit(); }
    ...
    public void visit(ErrorFormalPars ErrorFormalPars) { visit(); }
    public void visit(FormalParamDeclBrackets FormalParamDeclBrackets) { visit(); }
    public void visit(FormalParamDeclNoBrackets FormalParamDeclNoBrackets) { visit(); }
    ...
    public void visit(VarMultiDeclList VarMultiDeclList) { visit(); }
    ...
    public void visit(OneSingleConstDecl OneSingleConstDecl) { visit(); }
    public void visit(OneConstDeclList OneConstDeclList) { visit(); }
    ...
    public void visit(OneSingleVarDecl OneSingleVarDecl) { visit(); }
    public void visit(OneVarDeclList OneVarDeclList) { visit(); }
    public void visit(OneConstDeclListEnded OneConstDeclListEnded) { visit(); }
    public void visit(OneVarDeclListEnded OneVarDeclListEnded) { visit(); }
